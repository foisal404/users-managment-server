 ...
 * 3. set fetch method inside the fetch options (second parameter) method,headers,body
 ...
 * 7. On the server side: don't forget to use express.json() middleware app.use(express.json())
*/